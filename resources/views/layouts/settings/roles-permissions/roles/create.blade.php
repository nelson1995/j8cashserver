                        ...
                        <div class="x_content">
                            <div class="row">
                                <div class="col-sm-12">
									...
									@endif
									<form action="{{ route('store_role') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        {!! csrf_field() !!}
									
										<div class="item form-group">
											<label for="roles" class="col-form-label col-md-3 col-sm-3 label-align">Role</label>
											<div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="roles" name="name" required="required" value ="" class="form-control">
											</div>
                                        </div>
